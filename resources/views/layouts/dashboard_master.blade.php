  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="{{ url('/chart') }}" class="sl-menu-link @yield('chart')">
          <div class="sl-menu-item">
        ...
        <a href="#" class="sl-menu-link @yield('active_form')">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ url('/contact/admin/view') }}" class="nav-link @yield('contact')">Contact</a></li>
          <li class="nav-item"><a href="{{ url('/contact/admin/view/trash') }}" class="nav-link @yield('trash')">Trash</a></li>
          
        </ul>
        <a href="#" class="sl-menu-link @yield('active_prod')">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ url('/product/admin') }}" class="nav-link @yield('admin_pro')">Admin Product</a></li>
          <li class="nav-item"><a href="{{ url('product/admin/faq') }}" class="nav-link @yield('admin_faq')">Product FAQ</a></li>
          
        </ul>
        <a href="#" class="sl-menu-link @yield('header&footer')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-bookmarks-outline tx-20"></i>
            <span class="menu-item-label">Web Site Deteils</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ url('banner/admin') }}" class="nav-link @yield('banner')">Banner</a></li>
          <li class="nav-item"><a href="{{ url('admin/clients') }}" class="nav-link @yield('clients')">Clients Review</a></li>
        </ul>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item">
            <a href="{{ url('blog/admin/add') }}" class="nav-link @yield('blog_add')">Add Blog</a>
            <a href="{{ url('blog/admin') }}" class="nav-link @yield('blog_admin')">All Blog</a>
            <a href="{{ url('/blog/admin/add/category') }}" class="nav-link @yield('blog_cate')">Category</a>
          </li>
        </ul>
        <a href="#" class="sl-menu-link @yield('copon')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-navigate-outline tx-24"></i>
            <span class="menu-item-label">Copons</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ url('/copon/admin') }}" class="nav-link @yield('copon_ad')">All Copons</a></li>
    ...
    <div class="sl-header">
      ...
      <div class="sl-header-right">
        ...
        <div class="navicon-right">
          <a id="btnRightMenu" href="{{ url('/') }}" target="_blank" class="pos-relative">
    ...
    <div class="sl-sideright">
      <ul class="nav nav-tabs nav-fill sidebar-tabs" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" data-toggle="tab" role="tab" href="#messages">Messages ({{ Contact::count() }})</a>
        </li>
        <li class="nav-item">
            ...
            <a href="" class="media-list-link">
              <div class="media">
                ...
                <div class="media-body">
                  <p class="mg-b-0 tx-medium tx-gray-800 tx-13">Dynamic</p>
